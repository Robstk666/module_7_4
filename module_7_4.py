...
# 1. Количество задач, решённых второй командой
print("Команда Волшебники данных решила задач: {} !".format(score_2))

# 2. Время, за которое вторая команда решила задачи
print("Волшебники данных решили задачи за {:.1f} с !".format(team2_time))

# Использование f-строк
# 1. Количество решённых задач по командам
print(f"Команды решили {score_1} и {score_2} задач.")

# 2. Исход соревнования
print(f"Результат битвы: {challenge_result}")

# 3. Количество задач и среднее время решения
